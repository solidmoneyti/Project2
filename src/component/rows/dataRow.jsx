        ...
        <table className='bg-white p-4 rounded shadow-lg border-0'>
          <thead className='bg-white p-4 rounded'>
            <tr>
              ...
              <th className='bg-blue-500 border-0 w-10'></th>
            </tr>
          </thead>
          <tbody>
            {tableData.map((transaction, index) => (
              <tr key={index} className='border-0'>
                ...
                <td className='border-0 w-10 pl-6' style={{backgroundColor: transaction.type === 'expense' ? 'rgb(244, 151, 142)' : 'rgb(149, 213, 178)'}}><button className='block' onClick={() => handleDelete(index, transaction.type)}><svg className='flex ml-4 bi bi-trash' xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black" viewBox="0 0 16 16">
